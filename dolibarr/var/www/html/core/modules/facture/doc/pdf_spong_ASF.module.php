...
/**
 *  \file       htdocs/core/modules/facture/doc/pdf_sponge_ASF.modules.php
 *  \ingroup    facture
 ...
 */
class pdf_sponge_ASF extends ModelePDFFactures
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->db = $db;
		$this->name = "sponge_ASF";
		$this->description = $langs->trans('PDFSpongeASFDescription');
			...
			if (file_exists($dir)) {
				...
				if (($deja_regle || $amount_credit_notes_included || $amount_deposits_included) && empty($conf->global->INVOICE_NO_PAYMENT_DETAILS)) {
					$posy = $this->drawPaymentsTable($pdf, $object, $posy, $outputlangs);
						...
						$pdf->Image('http://localhost/core/modules/facture/doc/sign/stamp_asf_signed.png',120,243,74);
